...
async function main() {
    ...
    const initData = {
      _owner:owner.address,
       _aavePool :addrs.POOL,
       _radiantPool:addrs.RPOOL,
      _lendFeesRecipient:owner.address,
    }
    global.saltTable = {
        "impl":salts.impl,
        "admin":salts.admin,
    ...
    // console.log("Account balance:", (await deployer.getBalance()).toString());
       ...
       //withdraw USDC
       await auSDC.approve(lendContract.address,ethers.utils.parseUnits("10","gwei").mul(100000-fee).div(100000));
       await lendContract.lendWithdraw(0,ethers.utils.parseUnits("10","gwei").mul(100000-fee).div(100000));
       ...
       //withdraw DAI
       await adAI.approve(lendContract.address,ethers.utils.parseUnits("1","ether").mul(100000-fee).div(100000));
       await lendContract.lendWithdraw(1,ethers.utils.parseUnits("1","ether").mul(100000-fee).div(100000));
       ...
       //withdraw USDT
       await auSDT.approve(lendContract.address,ethers.utils.parseUnits("1","gwei").mul(100000-fee).div(100000));
       await lendContract.lendWithdraw(2,ethers.utils.parseUnits("1","gwei").mul(100000-fee).div(100000));
       ...
       console.log("aUSDTbalance1",aUSDTbalance1);
          ...
          console.log("raddr1USDC",raddr1USDC);
           ...
           await rauSDC.approve(lendContract.address,ethers.utils.parseUnits("10","gwei").mul(100000-fee).div(100000));
           await lendContract.lendWithdraw(4,ethers.utils.parseUnits("10","gwei").mul(100000-fee).div(100000));
